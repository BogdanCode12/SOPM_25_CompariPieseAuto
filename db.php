...
// Folosește UTF-8, erori ca excepții și conexiune unică (singleton).
...
function db(): PDO {
    ...
    $options = [
        ...
        PDO::ATTR_EMULATE_PREPARES   => false,                  // folosește prepared native
        PDO::ATTR_PERSISTENT         => false,                  // conexiune non-persistentă
    ];

    try {
        $pdo = new PDO($dsn, $db_user, $db_pass, $options);
    } catch (Throwable $e) {
        // Mesaj prietenos, fără expunere de credențiale
        http_response_code(500);
        exit('Eroare: conexiunea la baza de date a eșuat. Verifică setările din db.php.');
    }

    return $pdo;
}

// —— Helper-uri utile pentru interogări sigure ——————————————————————
